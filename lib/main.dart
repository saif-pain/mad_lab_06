        ...
        home: Scaffold(
              ...
              child: ListView(
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text("Home"),
                    trailing: ElevatedButton(onPressed: (){}, child: Text("HI")),
                    onTap: () {},
                  ),
                  ListTile(
            ...
            body: SingleChildScrollView(
              child: Column(children: [
                ...
                CachedNetworkImage(
                  imageUrl:
                      "https://t4.ftcdn.net/jpg/09/45/20/97/360_F_945209778_QNLukvfcQL0kkcClajN1FYCHb12pKUfv.jpg",
                  placeholder: (context, url) => CircularProgressIndicator(),
                  errorWidget: (context, url, error) => Icon(Icons.error),
                ),
                CachedNetworkImage(
                  imageUrl:
                      "https://cdn.pixabay.com/photo/2018/10/09/10/01/architecture-3734552_640.jpg",
                  placeholder: (context, url) => CircularProgressIndicator(),
                  errorWidget: (context, url, error) => Icon(Icons.error),
                ),
                Image(
